            ...
            <Row>
                <Col md={6}>
                    <Jumbotron id="mistytitle">
						...
						<a className="icons" href="https://docs.mistyrobotics.com/onboarding/creating-skills/writing-skill/" target="_blank" rel="noopener noreferrer"><Image id="misty-light-logo" src={mistylightlogo} alt="img not found"></Image></a>
