                        ...
                        <Col md={12}>
                            <Panel>
                                ...
                                <Panel.Body id="skills-panel">
                                    <ul id="skills">
                                        <li>Node.js, Express, C# / .NET, JavaScript / TypeScript, ReactJS, REST API, Websockets, MVC Framework, MongoDb / Mongoose, MySQL / Sequelize, Firebase, Visual Studio, Git / Github,
